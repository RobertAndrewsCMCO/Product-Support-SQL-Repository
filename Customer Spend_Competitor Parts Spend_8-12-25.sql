If(OBJECT_ID('tempdb..#MSPHDRS0') Is Not Null)
    ...
    WHERE CAST(try_convert(date,str(MSPHDRS0.IVDAT8),112) as date) >='2024-01-01'
...
/*SET Region By Manager*/
    ...
    WHERE CAST(try_convert(date,str(wophdrs0.IVDT8),112) as date) >='2024-01-01'
	...
	WHERE VERT.[Industry Code] IN ('805','791')
	and TYPE = 'PARTS'
	and USERCUNO NOT IN ('NCOH','UCOH')
	and USERCUNO NOT LIKE '%I%'
